...
//        std::ofstream sin_txt;
//        std::stringstream strPointTxtTitle;
//        strPointTxtTitle << "sin.txt";
//        sin_txt.open(strPointTxtTitle.str(), std::ios_base::out);
//        sin_txt << sin.str() << std::endl;
//        sin_txt.close();
